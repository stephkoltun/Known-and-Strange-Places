function createBuffer(offset, save) {
  var tempBufferObj = {
  ...
  for (var i = 0; i < allEntrances.length; i++) {
      ...
      var buffer = turf.buffer(entrance, offset, {units: 'kilometers'})
      ...
      var sourceName = 'TempBuffer' + i;
      var layerName = 'TempBuffer' + i;
      ...
      if (save && tempBufferObj.features.length == allEntrances.length) {
