...
#
pickle.dump([transparentImages, pca_features], open('data/features_blocks_trans.p', 'wb'))
# #pickle.dump([images, pca_features], open('data/features_blocks_solid.p', 'wb'))
